...
public class QueryAddlMethods extends Query {
  
//DL  HashMap<Node, ArrayList<Distribution>> nodeDistsMap = new HashMap<Node, ArrayList<Distribution>> ();
//DL // a query index for detecting outdated TwoOp computations
//DL protected static int COUNT = 0;
...
//DL public static int OPERATION_REUSE_COUNT = 0;
