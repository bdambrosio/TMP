...
public class RestrictedBoltzmannMachine extends  GraphTMP {

  protected static final Logger logWriter = Logger.getLogger(RestrictedBoltzmannMachine.class.getName());
  ...
  public RestrictedBoltzmannMachine(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public RestrictedBoltzmannMachine(Workspace workspace, boolean fromDB) {
    super(workspace, fromDB);
  }

  /* to support remove operation on collections, java objs are equal if id match */
  public boolean equals(Object o) {
    if (!(o instanceof RestrictedBoltzmannMachine)) //covers o == null case
      return false;
    RestrictedBoltzmannMachine other = (RestrictedBoltzmannMachine)o;
    if (this == other)
      return true;
    else
      return other.id == id;
...
/** method to marshall data from caching layer object to JSON **/
  public JSONObject asJSON () {
    ...
    try {
      jsonObj.put("class", "RestrictedBoltzmannMachine");
      jsonObj.put("id", id);
      if (getContext() != null) {
