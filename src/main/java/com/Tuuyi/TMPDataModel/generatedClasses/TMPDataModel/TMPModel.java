...
public class TMPModel extends DomainConcept {

  protected static final Logger logWriter = Logger.getLogger(TMPModel.class.getName());
  ...
  public TMPModel(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public TMPModel(Workspace workspace, boolean fromDB) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof TMPModel)) //covers o == null case
      return false;
    TMPModel other = (TMPModel)o;
    if (this == other)
      return true;
    else
      return other.id == id;
