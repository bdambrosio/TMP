...
import java.util.Stack;
  ...
  public class FibonacciHeap<T>  {
       ...
       *
       * @exception IllegalArgumentException Thrown if k is smaller than x.key
       * value.
       */
      public void increaseKey(FibonacciHeapNode<T> x, double k) {
          if (k < x.key) {
              throw new IllegalArgumentException(
                  "increaseKey() got larger key value");
          }
          x.key = k;
      ...
      public void delete(FibonacciHeapNode<T> x) {
          increaseKey(x, Double.POSITIVE_INFINITY);
          removeMax();
      }
      ...
      /**
       * Returns the smallest element in the heap. This smallest element is the one with the maximum key value.
       *
       * <p>Running time: O(1) actual</p>
       *
          ...
          if ((h1 != null) && (h2 != null)) {
              ...
              if (h.maxNode != null) {
                  if (h2.maxNode != null) {
                      ...
                      if (h2.maxNode.key > h1.maxNode.key) {
   ...
   * key value (which is used to determaxe the heap structure).
   *
