...
public class Token extends DomainConcept {

  protected static final Logger logWriter = Logger.getLogger(Token.class.getName());
  ...
  public Token(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public Token(Workspace workspace, boolean fromDB) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof Token)) //covers o == null case
      return false;
    Token other = (Token)o;
    if (this == other)
      return true;
