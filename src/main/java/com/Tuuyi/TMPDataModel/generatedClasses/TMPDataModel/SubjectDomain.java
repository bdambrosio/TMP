...
public class SubjectDomain extends DomainConcept {

  protected static final Logger logWriter = Logger.getLogger(SubjectDomain.class.getName());
  ...
  public SubjectDomain(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public SubjectDomain(Workspace workspace, boolean fromDB) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof SubjectDomain)) //covers o == null case
      return false;
    SubjectDomain other = (SubjectDomain)o;
    if (this == other)
      return true;
    else
      return other.id == id;
...
/** method to marshall data from caching layer object to JSON **/
  public JSONObject asJSON () {
    ...
    try {
      jsonObj.put("class", "SubjectDomain");
      jsonObj.put("id", id);
