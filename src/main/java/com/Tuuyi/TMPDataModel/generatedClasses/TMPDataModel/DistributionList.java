...
public class DistributionList extends DomainConcept {

  protected static final Logger logWriter = Logger.getLogger(DistributionList.class.getName());
  ...
  public DistributionList(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public DistributionList(Workspace workspace, boolean fromDB) {
  ...
  public void setId (int a_id) {
      if (a_id> -1) {
        id = a_id;
        DistributionListManager.getInstance().putInCache(this);
      }
  }

  /* to support remove operation on collections, java objs are equal if id match */
  public boolean equals(Object o) {
    if (!(o instanceof DistributionList)) //covers o == null case
      return false;
    DistributionList other = (DistributionList)o;
    if (this == other)
      return true;
    else
      return other.id == id;
...
/** method to marshall data from caching layer object to JSON **/
  public JSONObject asJSON () {
    ...
    try {
      jsonObj.put("class", "DistributionList");
      jsonObj.put("id", id);
