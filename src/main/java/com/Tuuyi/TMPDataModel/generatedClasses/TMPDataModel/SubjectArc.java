...
public class SubjectArc extends DomainConcept {

  protected static final Logger logWriter = Logger.getLogger(SubjectArc.class.getName());
  ...
  public SubjectArc(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public SubjectArc(Workspace workspace, boolean fromDB) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof SubjectArc)) //covers o == null case
      return false;
    SubjectArc other = (SubjectArc)o;
    if (this == other)
      return true;
    else
      return other.id == id;
