...
public class ArcManager extends DomainConceptManager<Arc> {

  protected static final AtomicBoolean check = new AtomicBoolean(false);
  protected static final ArcManager instance = new ArcManager();

  public ArcManager() {
    super();
    managedClass = Arc.class;
    this.NULLVALUE = new Arc(false);
