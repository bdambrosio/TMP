...
public class ArcPredicate extends DomainConcept {

  protected static final Logger logWriter = Logger.getLogger(ArcPredicate.class.getName());
  ...
  public ArcPredicate(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public ArcPredicate(Workspace workspace, boolean fromDB) {
  ...
  public boolean equals(Object o) {
    if (!(o instanceof ArcPredicate)) //covers o == null case
      return false;
    ArcPredicate other = (ArcPredicate)o;
    if (this == other)
      return true;
    else
      return other.id == id;
...
/** method to marshall data from caching layer object to JSON **/
  public JSONObject asJSON () {
    ...
    try {
      jsonObj.put("class", "ArcPredicate");
      jsonObj.put("id", id);
