...
public class BayesNet extends  GraphTMP {

  protected static final Logger logWriter = Logger.getLogger(BayesNet.class.getName());
  ...
  public BayesNet(boolean fromDB) {
    super(Workspace.getCurrentWorkspace(), fromDB);
  }
  public BayesNet(Workspace workspace, boolean fromDB) {
    super(workspace, fromDB);
  }

  /* to support remove operation on collections, java objs are equal if id match */
  public boolean equals(Object o) {
    if (!(o instanceof BayesNet)) //covers o == null case
      return false;
    BayesNet other = (BayesNet)o;
    if (this == other)
      return true;
    else
      return other.id == id;
