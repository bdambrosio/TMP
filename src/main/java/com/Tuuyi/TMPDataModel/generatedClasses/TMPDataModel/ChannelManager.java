...
public class ChannelManager extends DomainConceptManager<Channel> {

  protected static final AtomicBoolean check = new AtomicBoolean(false);
  protected static final ChannelManager instance = new ChannelManager();

  public ChannelManager() {
    super();
    managedClass = Channel.class;
    this.NULLVALUE = new Channel(false);
